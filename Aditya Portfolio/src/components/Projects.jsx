...
import finno from "../assets/finno.png"; // ✅ New project image
import assistant from "../assets/assistant.png"; // ✅ renamed and imported
import BrainWave from "../assets/BrainWave.png";
import scraper from "../assets/scraper.png";
import Converter from "../assets/Converter.png"; // ✅ New project image
...
const projects = [
    {
        ...
        year: "2025",
        description: "BrainWeb is an AI-powered educational platform that provides code generation, Q&A, summaries, and personalized learning tools in one interface..",
        image: BrainWave,
    ...
    },
    {
        ...
        year: "2025",
        description: "A powerful AI assistant using Gemini API for natural conversations, task automation, and semantic search.",
        demo: "https://huggingface.co/spaces/Aditya7777/AI-Assistant", // 🔁 Replace with your actual link
        github: "https://github.com/ADITYASINGH77770000/LLM/tree/main/LLM%20Projects/AI%20Assistant", // 🔁 Replace if available
        image: assistant,
    ...
    },
    {
        ...
        year: "2025",
        description: "innovix is an advanced financial analytics and prediction platform designed to provide intelligent insights into the stock market.",
        demo: "https://finnovix-bot-4.onrender.com/",  
        github: "https://github.com/ADITYASINGH77770000/Finance-Bot", 
        image: finno,  // 🔁 This uses the imported image
    ...
    },
    {
        ...
        year: "2025",
        description: "This Streamlit app scrapes any website URL, analyzes its content using Gemini AI, and generates a concise, insightful summary report..",
        demo: "https://huggingface.co/spaces/Aditya7777/Web-Scraper",
        github: "https://github.com/ADITYASINGH77770000/LLM/tree/main/LLM%20Projects/Web-Scraper",
        image: scraper,
    ...
    },
    {
        ...
        year: "2025",
        description: "This tool converts code from one programming language to another using Gemini AI, making it easier for developers to switch languages.",
        demo: "https://huggingface.co/spaces/Aditya7777/Code-Converter",
        github: "https://github.com/ADITYASINGH77770000/LLM/tree/main/LLM%20Projects/Code%20Converter",
        image: Converter,
